...
const menuItems = [
  ...
  { href: "/rekap", label: "Rekapitulasi", icon: IconRekap },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className={`${isCollapsed ? "w-[72px]" : "w-64"} transition-all duration-300 flex-shrink-0 flex flex-col bg-white/90 backdrop-blur-xl border-r border-slate-200 shadow-sm sticky top-0 h-screen`}>
      {/* Header */}
